...
public class WordCount {
    public static void main(String[] args) throws IOException {
        FileReader fileReader = new FileReader("src/StreamsFilesDirectories/04. Java-Advanced-Files-and-Streams-Exercises-Resources/words.txt");
        ...
        FileReader textReader = new FileReader("src/StreamsFilesDirectories/04. Java-Advanced-Files-and-Streams-Exercises-Resources/text.txt");
