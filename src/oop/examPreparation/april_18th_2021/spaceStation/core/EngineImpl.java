...
import oop.examPreparation.april_18th_2021.spaceStation.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String addPlanet(String[] data) {
        String[] planetItems = new String[data.length - 1];

        System.arraycopy(data, 1, planetItems, 0, data.length - 1);
